...
class Document extends Node {
        ...
        public function createProcessingInstruction($target, $data)
        {
                ...
                if (!\Dodo\whatwg\is_valid_xml_name($target) || strpos($data, '?'.'>') !== false) {
        ...
        public function createAttribute($localName)
        {
                ...
                if (!\Dodo\whatwg\is_valid_xml_name($localName)) {
                        \Dodo\error('InvalidCharacterError');
                }
                if ($this->isHTMLDocument()) {
                        $localName = \Dodo\to_ascii_lowercase($localName);
                }
        ...
        public function createElement($lname)
        {
                ...
                if (!\Dodo\whatwg\is_valid_xml_name($lname)) {
                ...
                //if ($this->_contentType === 'text/html') {
                        //if (!ctype_lower($lname)) {
                                //$lname = \Dodo\ascii_to_lowercase($lname);
                        //}
