...
trait Selectors {
	...
	public $invalidSelectors = [
		...
		[ 'name' => 'Invalid ID',
		  'selector' => '#' ],
		[ 'name' => 'Invalid group of selectors',
		  'selector' => 'div,' ],
		[ 'name' => 'Invalid class',
		  'selector' => '.' ],
		[ 'name' => 'Invalid class',
	...
	public $validSelectors = [
		[
			...
			'level' => 1,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		],
		[
			'name' => 'Type selector, matching html element',
			'selector' => 'html',
		...
		[
			'name' => 'Universal selector, matching all elements',
			'selector' => '*',
			'expect' => [
				'universal',
				'universal-p1',
			...
			'level' => 2,
			'testType' => WPTTestHarness::TEST_MATCH,
		],
		[
		...
		[
			'name' => 'Attribute presence selector, not matching title attribute, case sensitivity',
			'selector' => '#attr-presence [*|TiTlE]',
			'expect' => [],
			'exclude' => [ 'html' ],
			'level' => 2,
		...
		[
			'name' => 'Attribute value selector, matching align attribute with value, unclosed bracket',
			'selector' => '#attr-value [align="center"',
			'expect' => [ 'attr-value-div1' ],
			'level' => 2,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		...
		[
			'name' => ':nth-last-of-type selector, matching the third last em element',
		...
		[
			...
			'expect' => [ 'pseudo-first-child-span1',
		...
		[
			...
			'expect' => [ 'pseudo-last-child-span2',
		...
		// - :disabled             (Level 3)
		[
			'name' => ':disabled pseudo-class selector, matching all disabled form controls',
			'selector' => '#pseudo-ui :disabled',
			'expect' => [ 'pseudo-ui-input10',
						 'pseudo-ui-input11',
						 'pseudo-ui-input12',
						 'pseudo-ui-input13',
						 'pseudo-ui-input14',
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => ':not pseudo-class selector argument surrounded by spaces, matching ',
			'selector' => '#not>:not( div )',
			'expect' => [ 'not-p1',
						 'not-p2',
						 'not-p3' ],
		...
		[
			'name' => 'Class selector, matching element with class value using non-ASCII characters (1)',
			'selector' => ".台北Táiběi",
			'expect' => [ 'class-span1' ],
			'level' => 1,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		...
		[
			'name' => 'Class selector, chained, matching element with multiple class values using non-ASCII characters (1)',
		...
		[
			'name' => 'ID selector, matching id value using non-ASCII characters (1)',
			'selector' => "#台北Táiběi",
			'expect' => [ "台北Táiběi" ],
			'level' => 1,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		...
		[
			'name' => 'ID selector, matching id value using non-ASCII characters (2)',
			'selector' => "#台北",
			'expect' => [ "台北" ],
			'level' => 1,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		...
		[
			'name' => 'ID selector, matching id values using non-ASCII characters (1)',
			'selector' => "#台北Táiběi, #台北",
			'expect' => [ "台北Táiběi",
						 "台北" ],
			'level' => 1,
		...
		*/
		...
		[
			'name' => 'Slotted selector',
			'selector' => '::slotted(foo)',
			'expect' => [],
			'level' => 3,
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => 'Slotted selector (no matching closing paren)',
			'selector' => '::slotted(foo',
			'expect' => [],
			'level' => 3,
			'testType' => WPTTestHarness::TEST_QSA ] ];
	...
	public $scopedSelectors = [
		...
		[
			...
			'selector' => '#attr-presence-select3 option[selected]',
			'ctx' => '#attr-presence',
			'expect' => [ 'attr-presence-select3-option2',
						 'attr-presence-select3-option3' ],
			'level' => 2,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		],
		...
		[
			'name' => 'Attribute value selector with single-quoted value, matching multiple inputs with type attributes',
			'selector' => "input[type='hidden'],#attr-value input[type='radio']",
			'ctx' => '#attr-value',
			'expect' => [ 'attr-value-input3',
						 'attr-value-input4',
						 'attr-value-input6',
						 'attr-value-input8',
						 'attr-value-input9' ],
		...
		[
			'name' => 'Attribute whitespace-separated list selector with single-quoted value, matching multiple links with rel attributes',
			'selector' => "a[rel~='bookmark'],  #attr-whitespace a[rel~='nofollow']",
			'ctx' => '#attr-whitespace',
			'expect' => [ 'attr-whitespace-a1',
						 'attr-whitespace-a2',
						 'attr-whitespace-a3',
						 'attr-whitespace-a5',
						 'attr-whitespace-a7' ],
		...
		[
			'name' => ':nth-child selector, matching every second child element, starting from the fourth, with whitespace',
		...
		[
			'name' => ':nth-child selector, matching every fourth child element, starting from the third, with whitespace',
		...
		[
			'name' => ':nth-child selector used twice, matching ',
			'selector' => ':nth-child(1) :nth-child(1)',
			'ctx' => '#pseudo-nth',
			'expect' => [ 'pseudo-nth-table1',
						 'pseudo-nth-tr1' ],
			'level' => 3,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		],
		...
		[
			'name' => ':nth-last-child selector, matching every second child element from the end, starting from the fourth last',
			'selector' => 'li:nth-last-child(2n+4)',
			'ctx' => 'pseudo-nth',
			'expect' => [ 'pseudo-nth-li1',
						 'pseudo-nth-li3',
						 'pseudo-nth-li5',
		...
		[
			'name' => ':nth-of-type selector, matching every second elemetn of their type, starting from the first',
			'selector' => 'span:nth-of-type(2n-1)',
			'ctx' => '#pseudo-nth-p1',
			'expect' => [ 'pseudo-nth-span1',
						 'pseudo-nth-span3' ],
			'level' => 3,
		...
		[
			'name' => ':nth-last-of-type selector, matching the third last em element',
			'selector' => 'em:nth-last-of-type(3)',
			'ctx' => '#pseudo-nth-p1',
			'expect' => [ 'pseudo-nth-em2' ],
			'level' => 3,
			'testType' => WPTTestHarness::TEST_QSA | WPTTestHarness::TEST_MATCH,
		...
		[
			'name' => ':nth-last-of-type selector, matching every second last element of their type, starting from the last',
			'selector' => 'span:nth-last-of-type(2n-1)',
			'ctx' => '#pseudo-nth-p1',
			'expect' => [ 'pseudo-nth-span2',
						 'pseudo-nth-span4' ],
			'level' => 3,
		...
		[
			'name' => ':link and :visited pseudo-class selectors, matching a and area elements with href attributes',
			'selector' => ' :link, #pseudo-link :visited',
			'ctx' => '#pseudo-link',
			'expect' => [ 'pseudo-link-a1',
						 'pseudo-link-a2',
						 'pseudo-link-area1' ],
		...
		// - :lang()
		[
			'name' => ':lang pseudo-class selector, matching inherited language (1)',
			'selector' => '#pseudo-lang-div1:lang(en)',
			'ctx' => '',
			'expect' => [ 'pseudo-lang-div1' ],
			'exclude' => [ 'detached',
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => ':lang pseudo-class selector, matching specified language with exact value (1)',
			'selector' => '#pseudo-lang-div2:lang(fr)',
			'ctx' => '',
			'expect' => [ 'pseudo-lang-div2' ],
			'level' => 2,
		...
		[
			'name' => ':lang pseudo-class selector, matching specified language with partial value (1)',
			'selector' => '#pseudo-lang-div3:lang(en)',
			'ctx' => '',
			'expect' => [ 'pseudo-lang-div3' ],
			'level' => 2,
		...
		// - :enabled              (Level 3)
		[
			'name' => ':enabled pseudo-class selector, matching all enabled form controls (1)',
			'selector' => '#pseudo-ui :enabled',
			'ctx' => '',
			'expect' => [ 'pseudo-ui-input1',
						 'pseudo-ui-input2',
		...
		// - :disabled             (Level 3)
		[
			'name' => ':disabled pseudo-class selector, matching all disabled form controls (1)',
			'selector' => '#pseudo-ui :disabled',
			'ctx' => '',
			'expect' => [ 'pseudo-ui-input10',
						 'pseudo-ui-input11',
		...
		// - :checked              (Level 3)
		[
			'name' => ':checked pseudo-class selector, matching checked radio buttons and checkboxes (1)',
			'selector' => '#pseudo-ui :checked',
			'ctx' => '',
			'expect' => [ 'pseudo-ui-input4',
						 'pseudo-ui-input6',
		...
		// - :not(s)               (Level 3)
		[
			'name' => ':not pseudo-class selector, matching (1)',
			'selector' => '#not>:not(div)',
			'ctx' => '',
			'expect' => [ 'not-p1',
						 'not-p2',
		...
		// Class Selectors
		[
			'name' => 'Class selector, matching element with specified class (1)',
			'selector' => '.class-p',
			'ctx' => '',
			'expect' => [ 'class-p1',
						 'class-p2',
		...
		[
			'name' => 'Class selector, chained, matching only elements with all specified classes (1)',
			'selector' => '#class .apple.orange.banana',
			'ctx' => '',
			'expect' => [ 'class-div1',
						 'class-div2',
		...
		[
			'name' => 'Class Selector, chained, with type selector (1)',
			'selector' => 'div.apple.banana.orange',
			'ctx' => '',
			'expect' => [ 'class-div1',
						 'class-div2',
		...
		[
			'name' => 'Class selector, matching element with class value using non-ASCII characters (2)',
			'selector' => ".台北Táiběi",
			'ctx' => '',
			'expect' => [ 'class-span1' ],
			'level' => 1,
		...
		[
			'name' => 'Class selector, matching multiple elements with class value using non-ASCII characters (1)',
			'selector' => ".台北",
			'ctx' => '',
			'expect' => [ 'class-span1',
						 'class-span2' ],
		...
		[
			'name' => 'Class selector, chained, matching element with multiple class values using non-ASCII characters (2)',
			'selector' => ".台北Táiběi.台北",
			'ctx' => '',
			'expect' => [ 'class-span1' ],
			'level' => 1,
		...
		[
			'name' => 'Class selector, matching element with class with escaped character (1)',
			'selector' => '.foo\:bar',
			'ctx' => '',
			'expect' => [ 'class-span3' ],
			'level' => 1,
		...
		// ID Selectors
		[
			'name' => 'ID selector, matching element with specified id (1)',
			'selector' => '#id #id-div1',
			'ctx' => '',
			'expect' => [ 'id-div1' ],
			'level' => 1,
		...
		[
			'name' => 'ID selector, chained, matching element with specified id (1)',
			'selector' => '#id-div1, #id-div1',
			'ctx' => '',
			'expect' => [ 'id-div1' ],
			'level' => 1,
		...
		[
			'name' => 'ID Selector, chained, with type selector (1)',
			'selector' => 'div#id-div1, div#id-div2',
			'ctx' => '',
			'expect' => [ 'id-div1',
						 'id-div2' ],
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => 'ID selector, matching multiple elements with duplicate id (1)',
			'selector' => '#id-li-duplicate',
			'ctx' => '',
			'expect' => [ 'id-li-duplicate',
						 'id-li-duplicate',
		...
		[
			'name' => 'ID selector, matching id value using non-ASCII characters (3)',
			'selector' => "#台北Táiběi",
			'ctx' => '',
			'expect' => [ "台北Táiběi" ],
			'level' => 1,
		...
		[
			'name' => 'ID selector, matching id value using non-ASCII characters (4)',
			'selector' => "#台北",
			'ctx' => '',
			'expect' => [ "台北" ],
			'level' => 1,
		...
		[
			'name' => 'ID selector, matching id values using non-ASCII characters (2)',
			'selector' => "#台北Táiběi, #台北",
			'ctx' => '',
			'expect' => [ "台北Táiběi",
						 "台北" ],
		...
		// - Descendant combinator ' '
		[
			'name' => 'Descendant combinator, matching element that is a descendant of an element with id (1)',
			'selector' => '#descendant div',
			'ctx' => '',
			'expect' => [ 'descendant-div1',
						 'descendant-div2',
		...
		[
			'name' => 'Descendant combinator, matching element with id that is a descendant of an element (1)',
			'selector' => 'body #descendant-div1',
			'ctx' => '',
			'expect' => [ 'descendant-div1' ],
			'exclude' => [ 'detached',
		...
		[
			'name' => 'Descendant combinator, matching element with id that is a descendant of an element with id (1)',
			'selector' => '#descendant #descendant-div2',
			'ctx' => '',
			'expect' => [ 'descendant-div2' ],
			'level' => 1,
		...
		[
			'name' => 'Descendant combinator, matching element with class that is a descendant of an element with id (1)',
			'selector' => '#descendant .descendant-div2',
			'ctx' => '',
			'expect' => [ 'descendant-div2' ],
			'level' => 1,
		...
		[
			'name' => 'Descendant combinator, matching element with class that is a descendant of an element with class (1)',
			'selector' => '.descendant-div1 .descendant-div3',
			'ctx' => '',
			'expect' => [ 'descendant-div3' ],
			'level' => 1,
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => 'Descendant combinator, whitespace characters (1)',
			'selector' => "#descendant\t\r\n#descendant-div2",
			'ctx' => '',
			'expect' => [ 'descendant-div2' ],
			'level' => 1,
		...
		// - Child combinator '>'
		[
			'name' => 'Child combinator, matching element that is a child of an element with id (1)',
			'selector' => '#child>div',
			'ctx' => '',
			'expect' => [ 'child-div1',
						 'child-div4' ],
		...
		[
			'name' => 'Child combinator, matching element with id that is a child of an element (1)',
			'selector' => 'div>#child-div1',
			'ctx' => '',
			'expect' => [ 'child-div1' ],
			'level' => 2,
		...
		[
			'name' => 'Child combinator, matching element with id that is a child of an element with id (1)',
			'selector' => '#child>#child-div1',
			'ctx' => '',
			'expect' => [ 'child-div1' ],
			'level' => 2,
		...
		[
			'name' => 'Child combinator, matching element with id that is a child of an element with class (1)',
			'selector' => '#child-div1>.child-div2',
			'ctx' => '',
			'expect' => [ 'child-div2' ],
			'level' => 2,
		...
		[
			'name' => 'Child combinator, matching element with class that is a child of an element with class (1)',
			'selector' => '.child-div1>.child-div2',
			'ctx' => '',
			'expect' => [ 'child-div2' ],
			'level' => 2,
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => 'Child combinator, surrounded by whitespace (1)',
			'selector' => "#child-div1\t\r\n>\t\r\n#child-div2",
			'ctx' => '',
			'expect' => [ 'child-div2' ],
			'level' => 2,
		...
		[
			'name' => 'Child combinator, whitespace after (1)',
			'selector' => "#child-div1>\t\r\n#child-div2",
			'ctx' => '',
			'expect' => [ 'child-div2' ],
			'level' => 2,
		...
		[
			'name' => 'Child combinator, whitespace before (1)',
			'selector' => "#child-div1\t\r\n>#child-div2",
			'ctx' => '',
			'expect' => [ 'child-div2' ],
			'level' => 2,
		...
		[
			'name' => 'Child combinator, no whitespace (1)',
			'selector' => '#child-div1>#child-div2',
			'ctx' => '',
			'expect' => [ 'child-div2' ],
			'level' => 2,
		...
		// - Adjacent sibling combinator '+'
		[
			'name' => 'Adjacent sibling combinator, matching element that is an adjacent sibling of an element with id (1)',
			'selector' => '#adjacent-div2+div',
			'ctx' => '',
			'expect' => [ 'adjacent-div4' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, matching element with id that is an adjacent sibling of an element (1)',
			'selector' => 'div+#adjacent-div4',
			'ctx' => '',
			'expect' => [ 'adjacent-div4' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, matching element with id that is an adjacent sibling of an element with id (1)',
			'selector' => '#adjacent-div2+#adjacent-div4',
			'ctx' => '',
			'expect' => [ 'adjacent-div4' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, matching element with class that is an adjacent sibling of an element with id (1)',
			'selector' => '#adjacent-div2+.adjacent-div4',
			'ctx' => '',
			'expect' => [ 'adjacent-div4' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, matching element with class that is an adjacent sibling of an element with class (1)',
			'selector' => '.adjacent-div2+.adjacent-div4',
			'ctx' => '',
			'expect' => [ 'adjacent-div4' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, matching p element that is an adjacent sibling of a div element (1)',
			'selector' => '#adjacent div+p',
			'ctx' => '',
			'expect' => [ 'adjacent-p2' ],
			'level' => 2,
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => 'Adjacent sibling combinator, surrounded by whitespace (1)',
			'selector' => "#adjacent-p2\t\r\n+\t\r\n#adjacent-p3",
			'ctx' => '',
			'expect' => [ 'adjacent-p3' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, whitespace after (1)',
			'selector' => "#adjacent-p2+\t\r\n#adjacent-p3",
			'ctx' => '',
			'expect' => [ 'adjacent-p3' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, whitespace before (1)',
			'selector' => "#adjacent-p2\t\r\n+#adjacent-p3",
			'ctx' => '',
			'expect' => [ 'adjacent-p3' ],
			'level' => 2,
		...
		[
			'name' => 'Adjacent sibling combinator, no whitespace (1)',
			'selector' => '#adjacent-p2+#adjacent-p3',
			'ctx' => '',
			'expect' => [ 'adjacent-p3' ],
			'level' => 2,
		...
		// - General sibling combinator ~ (Level 3)
		[
			'name' => 'General sibling combinator, matching element that is a sibling of an element with id (1)',
			'selector' => '#sibling-div2~div',
			'ctx' => '',
			'expect' => [ 'sibling-div4',
						 'sibling-div6' ],
		...
		[
			'name' => 'General sibling combinator, matching element with id that is a sibling of an element (1)',
			'selector' => 'div~#sibling-div4',
			'ctx' => '',
			'expect' => [ 'sibling-div4' ],
			'level' => 3,
		...
		[
			'name' => 'General sibling combinator, matching element with id that is a sibling of an element with id (1)',
			'selector' => '#sibling-div2~#sibling-div4',
			'ctx' => '',
			'expect' => [ 'sibling-div4' ],
			'level' => 3,
		...
		[
			'name' => 'General sibling combinator, matching element with class that is a sibling of an element with id (1)',
			'selector' => '#sibling-div2~.sibling-div',
			'ctx' => '',
			'expect' => [ 'sibling-div4',
						 'sibling-div6' ],
		...
		[
			'name' => 'General sibling combinator, matching p element that is a sibling of a div element (1)',
			'selector' => '#sibling div~p',
			'ctx' => '',
			'expect' => [ 'sibling-p2',
						 'sibling-p3' ],
		...
		[
			...
			'testType' => WPTTestHarness::TEST_QSA ],
		[
			'name' => 'General sibling combinator, surrounded by whitespace (1)',
			'selector' => "#sibling-p2\t\r\n~\t\r\n#sibling-p3",
			'ctx' => '',
			'expect' => [ 'sibling-p3' ],
			'level' => 3,
		...
		[
			'name' => 'General sibling combinator, whitespace after (1)',
			'selector' => "#sibling-p2~\t\r\n#sibling-p3",
			'ctx' => '',
			'expect' => [ 'sibling-p3' ],
			'level' => 3,
		...
		[
			'name' => 'General sibling combinator, whitespace before (1)',
			'selector' => "#sibling-p2\t\r\n~#sibling-p3",
			'ctx' => '',
			'expect' => [ 'sibling-p3' ],
			'level' => 3,
		...
		[
			'name' => 'General sibling combinator, no whitespace (1)',
			'selector' => '#sibling-p2~#sibling-p3',
			'ctx' => '',
			'expect' => [ 'sibling-p3' ],
			'level' => 3,
		...
		// Group of selectors (comma)
		[
			'name' => 'Syntax, group of selectors separator, surrounded by whitespace (1)',
			'selector' => "#group em\t\r \n,\t\r \n#group strong",
			'ctx' => '',
			'expect' => [ 'group-em1',
						 'group-strong1' ],
		...
		[
			'name' => 'Syntax, group of selectors separator, whitespace after (1)',
			'selector' => "#group em,\t\r\n#group strong",
			'ctx' => '',
			'expect' => [ 'group-em1',
						 'group-strong1' ],
		...
		[
			'name' => 'Syntax, group of selectors separator, whitespace before (1)',
			'selector' => "#group em\t\r\n,#group strong",
			'ctx' => '',
			'expect' => [ 'group-em1',
						 'group-strong1' ],
		...
		[
			'name' => 'Syntax, group of selectors separator, no whitespace (1)',
			'selector' => '#group em,#group strong',
			'ctx' => '',
			'expect' => [ 'group-em1',
						 'group-strong1' ],
