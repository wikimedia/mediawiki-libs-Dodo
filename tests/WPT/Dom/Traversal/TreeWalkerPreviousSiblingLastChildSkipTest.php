...
class TreeWalkerPreviousSiblingLastChildSkipTest extends WPTTestHarness
{
    ...
    {
        $this->doc = $this->loadHtmlFile('vendor/web-platform-tests/wpt/dom/traversal/TreeWalker-previousSiblingLastChildSkip.html');
        $testElement = null;
        // setup()
        ...
        $this->assertTest(function () use(&$testElement) {
            ...
            $this->wptAssertNode($walker->nextNode(), ['type' => Element, 'id' => 'C2']);
            $this->wptAssertNode($walker->currentNode, ['type' => Element, 'id' => 'C2']);
            $this->wptAssertNode($walker->nextNode(), ['type' => Element, 'id' => 'D1']);
            $this->wptAssertNode($walker->currentNode, ['type' => Element, 'id' => 'D1']);
            $this->wptAssertNode($walker->nextNode(), ['type' => Element, 'id' => 'D2']);
            $this->wptAssertNode($walker->currentNode, ['type' => Element, 'id' => 'D2']);
            $this->wptAssertNode($walker->nextNode(), ['type' => Element, 'id' => 'B2']);
            $this->wptAssertNode($walker->currentNode, ['type' => Element, 'id' => 'B2']);
            $this->wptAssertNode($walker->getPreviousSibling()(), ['type' => Element, 'id' => 'C2']);
            $this->wptAssertNode($walker->currentNode, ['type' => Element, 'id' => 'C2']);
