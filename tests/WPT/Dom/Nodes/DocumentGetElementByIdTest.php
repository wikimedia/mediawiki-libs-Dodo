...
class DocumentGetElementByIdTest extends WPTTestHarness
{
    public function testDocumentGetElementById()
    {
        ...
        $this->assertTest(function () {
            $this->wptAssertEquals($this->doc->getElementById(''), null);
        ...
        $this->assertTest(function () {
            ...
            $this->wptAssertNotEquals($bar, null, 'should not be null');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $this->wptAssertNotEquals($result, null, 'should not be null.');
            $this->wptAssertEquals($result->tagName, 'DIV', "should have appended element's tag name");
            $this->wptAssertTrue($result instanceof HTMLDivElement, 'should be a valid Element instance');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $this->wptAssertEquals($e, $test, 'should get the element with id.');
            $old = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($old, null, "shouldn't get the element by the old id.");
            // remove id.
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $this->wptAssertNotEquals($target, null, 'should not be null');
            $this->wptAssertEquals($target->getAttribute('data-name'), '1st', 'should return the 1st');
            ...
            $this->wptAssertNotEquals($target2, null, 'should not be null');
            $this->wptAssertEquals($target2->getAttribute('data-name'), '1st', 'should be the 1st');
            ...
            $this->wptAssertNotEquals($target3, null, 'should not be null');
            $this->wptAssertEquals($target3->getAttribute('data-name'), '4th', 'should be the 4th');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $target = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($target, $element, 'should return the element before changing the value');
            $element->attributes[0]->value = $TEST_ID . '-updated';
            $target2 = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($target2, null, 'should return null after updated id via Attr.value');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $this->wptAssertEquals($test, $element->firstChild, 'should not be null');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $this->wptAssertEquals($this->doc->getElementById($TEST_ID), $element, 'should not be null');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $test = $this->doc->getElementById($TEST_ID);
            $this->wptAssertNotEquals($test, null, 'should not be null');
            $this->wptAssertEquals($test->tagName, 'DIV', 'should have expected tag name.');
            $this->wptAssertTrue($test instanceof HTMLDivElement, 'should be a valid Element instance');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $gBody->appendChild($element);
            $test = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($test, $element, 'should be equal to the appended element.');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $test = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($test, $element1, 'should return 1st element');
            $container->removeChild($element1);
            $test = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($test, $element2, 'should return 2nd element');
            $container->removeChild($element2);
            $test = $this->doc->getElementById($TEST_ID);
            $this->wptAssertEquals($test, $element3, 'should return 3rd element');
        ...
        $this->assertTest(function () use (&$gBody) {
            ...
            $a->appendChild($b);
            $b->id = $TEST_ID;
            $this->wptAssertEquals($this->doc->getElementById($TEST_ID), null);
            $gBody->appendChild($a);
            $this->wptAssertEquals($this->doc->getElementById($TEST_ID), $b);
        ...
        $this->assertTest(function () {
            ...
            $this->wptAssertEquals($this->doc->getElementById('heading'), null);
