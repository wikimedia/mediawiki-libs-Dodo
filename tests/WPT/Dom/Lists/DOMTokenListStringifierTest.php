...
class DOMTokenListStringifierTest extends WPTTestHarness
{
    public function testDOMTokenListStringifier()
    {
        ...
        $this->assertTest(function () {
            $this->wptAssertEquals(strval($this->doc->createElement('span')->classList), '', '$this->toString(classList) should return the empty list for an undefined class attribute');
            ...
            $this->wptAssertEquals(strval($span->classList), '   a  a b ', '$this->toString(classList) should return the literal value');
